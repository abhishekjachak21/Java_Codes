	...
	class Employee   implements Comparable<Employee> {
		...
		public int compareTo(Employee o) {
			if(this.employeeName.equals(o.employeeName)) {
	...
	public class SortMaster {
	  	public static void main(String[] args) {
	        ...
	        employees.add(new Employee(3, "nishtha",30000, "nishtha@gmail.com", "developer"));
	        employees.add(new Employee(4, "komal",23000, "rohit@gmail.com", "tester"));
	        employees.add(new Employee(2, "jatin",21000, "jatin@gmail.com", "trainer"));
	        employees.add(new Employee(6, "komal",22000, "komal@gmail.com", "trainer"));
			/*
			 * Collections.sort(employees); for(Employee e:employees) System.out.println(e);
			 */
