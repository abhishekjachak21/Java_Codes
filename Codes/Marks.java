...
public class Marks extends Frame implements ActionListener {
    ...
    private TextField[] subjectTextFields;
    ...
    private void initializeComponents() {
        ...
        subjectTextFields = new TextField[5];

        subjectLabels[0] = new Label("CS");
        subjectLabels[1] = new Label("DC");
        subjectLabels[2] = new Label("Java");
        subjectLabels[3] = new Label("C++");
        subjectLabels[4] = new Label("OOPS");

        for (int i = 0; i < 5; i++) {
            subjectLabels[i].setBounds(50, 50 + i * 50, 100, 30);
            subjectTextFields[i] = new TextField();
            subjectTextFields[i].setBounds(200, 50 + i * 50, 100, 30);
        }

        totalLabel = new Label();
        totalLabel.setBounds(50, 350, 100, 30);

        percentageLabel = new Label();
        percentageLabel.setBounds(200, 350, 100, 30);
    }

    private void addComponentsToFrame() {
        for (int i = 0; i < 5; i++) {
            f.add(subjectLabels[i]);
            f.add(subjectTextFields[i]);
        }
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        for (TextField field : subjectTextFields) {
            try {
        ...
        percentageLabel.setText("Percentage: " + average);
